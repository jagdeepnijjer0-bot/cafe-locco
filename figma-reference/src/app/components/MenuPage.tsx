...
import leafIcon from 'figma:asset/169350fde41f82040627754f92db518f9f63254a.png';
    ...
    <div className="w-full h-full bg-black relative overflow-hidden flex flex-col">
      ...
      <div className="border-b border-white/10 flex-shrink-0">
        <div className="flex items-center justify-between p-6">
          ...
          <h2 className="text-white text-sm tracking-[0.1em]">MENU</h2>
          <button 
          ...
          {categories.map((category) => {
            ...
            return (
              <button
                ...
                className="py-2 px-4 transition-all flex-shrink-0 whitespace-nowrap text-xs tracking-[0.05em] flex items-center gap-2 rounded-md"
                style={{
            ...
            <div key={item.name} className="border-b border-white/10 pb-6">
              <div className="flex items-start justify-between gap-4 mb-2">
                <div className="flex items-center gap-2 flex-1">
                  <h3 className="text-white text-xs tracking-[0.05em]">{item.name}</h3>
                  {item.name === 'AVO TOAST' && (
                    <img src={leafIcon} alt="" className="w-4 h-4" />
                  )}
                </div>
                <span className="text-white text-xs tracking-[0.05em] flex-shrink-0">£{item.price}</span>
              </div>
              {item.description && (
                <p className="text-white/40 text-[10px] tracking-[0.03em] leading-relaxed uppercase">
                  {item.description}
                </p>
              )}
            </div>
